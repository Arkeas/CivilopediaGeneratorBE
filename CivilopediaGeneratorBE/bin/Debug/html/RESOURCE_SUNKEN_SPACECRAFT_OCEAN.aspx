...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<title>CIVILOPEDIA Online: Sunken Spacecraft</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<div class="title">Sunken Spacecraft</div>
	<img src="/civilopediabe/images/large/RESOURCE_SUNKEN_SPACECRAFT_OCEAN.png" alt="Sunken Spacecraft" class="contentimage" />
...
<h2>Game Info:</h2><div class="infobox">Use an Explorer unit to build an Expedition here, and you will uncover rewards.</div>
		<h2>History</h2><div class="infobox">All over this planet, there are crashed satellites and other debris from space. However, this spcecraft was a manned vessel much larger than a simple orbital machine. There is no indication where these vessels come from. Scientists do not suspect they came from Earth, yet they are also not showing progenitor characteristics. There needs to be more research done to find out how these spacecraft came about.</div>
	</div>
</asp:Content>
